...
Next, create a stored procedure that calls Azure OpenAI to generate vectors for each movie title in the database. We'll also use the same stored procedure to generate vectors for each natural language query supplied by users later on (at "chat" time).
...
▶ [Lab: Vector Utility Functions](https://github.com/lennilobel/sql2025-workshop-hol-redmond2026/blob/main/HOL/4.%20AI%20Features/2.%20Vector%20Utility%20Functions.md)
